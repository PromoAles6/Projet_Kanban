          ...
          <div class="card">
            ...
            <div class="myCards">
                <?php if ($card->getList_id() === $list->getId()) : ?>
                  <button type="button" id="draggable" class="btn btn-<?= $card->getColor() ?>" data-bs-toggle="modal" data-bs-target="#modal<?= $card->getId() ?>" data-bs-whatever="@mdo"> <?= $card->getName()?> </button>
                <?php endif ?>
            </div>
            ...
            <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">enregister</button>
                    <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">supprimer</button>
