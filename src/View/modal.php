...
<body>
  ...
  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-action">A faire</a>
    <div style="display: flex; flex-direction: column;">
      <?php foreach ($cards as $card) : ?>
        <div><button type="button" class="btn btn-<?= $card->getColor() ?>" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><?= $card->getName() ?></button></div>
      <?php endforeach ?>
